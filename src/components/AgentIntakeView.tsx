        ...
        <div>
          ...
          <div className="mt-5 space-y-4 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border-2 border-amber-300 hover:border-amber-500 bg-gradient-to-b from-amber-50/90 via-white to-amber-50/40 rounded-xl p-3 sm:p-3.5 shadow-2xs hover:shadow-xs transition-all duration-200 flex flex-col justify-between group">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <label className="block font-black text-amber-950 text-xs tracking-wide uppercase truncate" title="Ancienneté conservée (mois)">
                        Ancienneté conservée
                      </label>
                    </div>
                    <span className="text-[11px] font-mono font-black px-1.5 py-0.5 rounded shadow-2xs bg-amber-100 text-amber-950 border border-amber-300 shrink-0">
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    <input
                      ...
                      className="w-20 bg-white border border-amber-300 rounded-lg px-2 py-1.5 text-slate-900 font-bold text-xs text-center focus:bg-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all shadow-2xs"
                    />
