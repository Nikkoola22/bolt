...
import { FileSignature, Copy, CircleCheck, User, Building, Calendar, Info, FileText, Briefcase, FileBadge } from "lucide-react";
            ...
            <div className="p-10 font-serif text-[13px] leading-relaxed text-slate-900 dark:text-slate-200 max-h-[600px] overflow-y-auto" id="arrete-content">
              ...
              <div className="space-y-4 text-justify">
                ...
                <p className="text-xs italic mt-6 border-t border-slate-300 pt-4">
                  Le Maire / Le Président informe que le présent arrêté peut faire l'objet d'un recours pour excès de pouvoir devant le Tribunal Administratif de {renderField(villeTA, "VILLE DU T.A.")} dans un délai de deux mois à compter de sa notification. Le tribunal administratif peut être saisi par l'application informatique "Télérecours citoyens" accessible par le site internet www.telerecours.fr.
                </p>
